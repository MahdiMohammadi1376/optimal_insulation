...
config.py
---------
All constants, material properties, and NSGA-II hyperparameters.
Edit this file to add new materials or tune the optimizer.
"""
...
# ---------------------------------------------------------------------------
# Insulation materials  {id: {name, lambda [W/mK], density [kg/m³],
#                              co2_ef [kg CO₂/kg], cost [currency/cm/m²]}}
# ---------------------------------------------------------------------------
MATERIALS = {
...
N_GENERATIONS = 50
RANDOM_SEED   = 42
REF_POINT     = np.array([2.5e10, 2e6])   # for Hypervolume indicator
